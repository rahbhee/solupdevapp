...
const PortfolioAll = ({ handleAllClick }) => {
  ...
  return (
    <div className='flex flex-col gap-2'>
      <PortfolioNav handleAllClick={handleAllClick} />

      <div className='text-xs grid md:gap-4 grid-cols-7 gap-6 portfolio bg-white font-semibold'>
        <div className='py-2 col-span-2 md:py-6 px-4 flex items-center justify-center md:px-6'>
          <h3>Project</h3>
        </div>
        <div className='py-2 col-span-1 md:py-6 px-4 flex items-center justify-center md:px-6'>
          <h3>Shares</h3>
        </div>
        <div className='py-2 col-span-1 md:py-6 px-4 flex items-center justify-center md:px-6'>
          <h3>Price/share</h3>
        ...
        <div className='py-2 col-span-1 md:py-6 flex items-center justify-center px-4'>
          <h3>Date created</h3>
        </div>
        <div className='py-2 col-span-1 md:py-6 flex items-center justify-center px-4 md:px-6'>
          <h3>Stats</h3>
        </div>
      </div>
